...
namespace Domain
{
    ...
    {
        public ClassSessionsFull ClassSessions1 { get; set; }
        public ClassSessionsFull ClassSessions2 { get; set; }
        public ClassSessionsFull ClassSessions3 { get; set; }
        public ClassSessionsFull ClassSessions4 { get; set; }
        public int Id { get; set; }
        public bool Day { get; set; }
        ...
        public DayInScheduleFull1(ClassSessionsFull classSessions1, ClassSessionsFull classSessions2, ClassSessionsFull classSessions3, ClassSessionsFull classSessions4, bool day)
        {
            Id = new Random().Next();
